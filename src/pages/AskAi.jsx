  ...
  <div className="flex flex-col items-center justify-center w-full bg-black mt-4">
    ...
    <div className="flex flex-col w-full max-w-4xl px-4 py-4 space-y-4 z-10">
      <div className="w-full flex items-center">
        ...
        />
        <button onClick={handleSubmit} className="w-16 h-16 rounded-full bg-lime-300 text-black font-bold text-3xl text-center ml-4">
            ...
            >
              <div className="flex items-start">
                <div className="flex items-center space-x-2">
                  <div className="w-8 h-8 bg-black border border-white text-white font-bold rounded-full flex items-center justify-center">
                    Me
                  </div>
              ...
              <div className="flex items-end justify-end">
                <div className="flex items-center space-x-2">
                  <div className="w-8 h-8 bg-black text-white border-2 border-purple-800 rounded-full flex items-center justify-center font-bold">
                    AI
                  </div>
