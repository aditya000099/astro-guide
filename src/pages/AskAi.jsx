            ...
            <div className="space-y-2">
              {chatHistory.map((chat, index) => (
                <div
                  ...
                  ref={index === 0 ? endOfChatRef : null} // Set ref to the last chat
                >
                  ...
                  <div className="flex items-end justify-end">
                    <div className="flex items-center space-x-2">
                      <div className="w-8 h-8 bg-black text-white border-2 border-purple-800 rounded-full flex items-center justify-center p-6 font-bold">
                        AI
                      </div>
